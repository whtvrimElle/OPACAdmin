...
Public Class userTable
    ...
    Private Sub searchDataTable_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles searchDataTable.CellDoubleClick
        ...
        Try
            ...
            Dim textboxes As New List(Of Object)({userEdit.idText, userEdit.firstNameText, userEdit.middleNameText, userEdit.lastNameText, userEdit.departmentText, userEdit.courseText, userEdit.courseText})
